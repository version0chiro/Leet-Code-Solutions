...
<pre style="position: relative;"><strong>Input: </strong><span id="example-input-1-1">[1,0,2,3,0,4,5,0]</span>
...
<pre style="position: relative;"><strong>Input: </strong><span id="example-input-2-1">[1,2,3]</span>
<strong>Output: </strong>null
